...
// ============================================
// BONUS: Additional Named Exports
// ============================================
...
// Circle as a named export (not default, to avoid duplicate default export)
export class Circle {
    constructor(radius) {
        this.radius = radius;
    }
...
// Default export - export one main thing (Rectangle is the default)
...
// import { calculateArea, calculatePerimeter, Circle } from './modules.js';
...
// Default export: MathUtils.default (or MathUtils.Rectangle won't work, use MathUtils.default)
